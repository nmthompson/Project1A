...
public:
	...
	Assignment createAssignment(string& assign_str); // Creates an assignments from a string
	...
	void complete(list<Assignment>& the_list, list<Assignment>::iterator& iter); // Complete an assignment
